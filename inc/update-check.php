...
function url_fallback_show_update_notice() {
    ...
    echo '&#x1F195; <strong>YOURLS URL Fallback</strong>: New version available: <strong>' . yourls_esc_attr( $info['latest_version'] ) . '</strong>! ';
    echo '<a href="' . yourls_esc_url( $info['release_url'] ) . '" target="_blank" rel="noopener noreferrer">View details on GitHub</a>';
    echo '</div>';
}
