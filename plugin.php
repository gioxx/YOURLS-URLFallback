...
define( 'URL_FALLBACK_VERSION',    '1.1.3' );
...
yourls_add_action( 'plugins_loaded', 'url_fallback_boot' );
function url_fallback_boot() {
    url_fallback_load_textdomain();
    yourls_register_plugin_page( 'url_fallback', yourls__( 'URL Fallback', 'yourls-url-fallback' ), 'url_fallback_config_page' );
}
